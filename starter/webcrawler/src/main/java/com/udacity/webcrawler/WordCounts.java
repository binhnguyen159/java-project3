...
//    return topCounts;
    ...
    return wordCounts.entrySet().stream().sorted(comparator).limit(Math.min(popularWordCount, wordCounts.size())).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue,(k,v)-> k, LinkedHashMap::new));
  }
